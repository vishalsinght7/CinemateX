...
<template>
    <div class="bg-cyan-50 rounded-lg overflow-hidden m-4 px-2">
    <div class="p-1 py-4">
     <h3 class="font-semibold text-lg mb-2 text-center">
      {{ title }} 
     </h3>
     <div class="overflow-hidden mb-4">
    <img class="h400 w-300 object-cover"
          ...
          />
             ...
             <div class="mt-4 p-2 text-right">
                   <NuxtLink :to="`/movie/${movieid}`"
                              class="bg-rose-500 hover:bg-rose-650 text-white font-medium py-2 px-4 rounded">
                                    Get Details
                  </NuxtLink>
         </div>
    </div>
